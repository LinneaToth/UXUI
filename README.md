...
**- Usability Testing:** Evaluating designs through methods like "Thinking Aloud" and A/B testing to gather actionable feedback.
...
**- Flowcharts** illustrating user interactions.
**- High-fidelity Mockups** created in Figma with a focus on Gestalt principles.
